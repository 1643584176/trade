...
class RealTimeTraderM15:
    ...
    def __init__(self, model_path="gbpusd_trained_model.pkl", magic_number=20000001):
        """
        初始化实时交易器
        ...
        try:
            ...
            # 初始化时检查现有持仓
            self._check_existing_positions("GBPUSD")
        except Exception as e:
    ...
    def run(self, symbol="GBPUSD", lot_size=1.0):
        """
        运行实时交易
