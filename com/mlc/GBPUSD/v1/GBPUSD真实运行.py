...
def run_strategy():
    ...
    global daily_trades, daily_pnl, total_pnl, last_trading_day, last_close_time
    ...
    while True:  # 持续运行循环
        try:
            ...
            if current_position is None and current_lot > 0:
                ...
                print(f"分析H1数据信号: 昨天星期={yesterday_weekday_chinese}, 今天星期={current_weekday_chinese}")
                ...
                if signal_type and direction:
                    ...
                    if signal_reasons:
                        ...
                        print("未满足入场条件，当前日期不符合任何交易信号触发条件")
                    print("继续等待")
