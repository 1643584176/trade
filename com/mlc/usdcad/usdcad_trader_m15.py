...
class RealTimeTraderM15:
    ...
    def __init__(self, model_path="usdcad_trained_model.pkl", magic_number=10032028):
        """
        初始化实时交易器
        ...
        try:
            ...
            # 初始化时检查现有持仓
            self._check_existing_positions("USDCAD")
        except Exception as e:
    ...
    def run(self, symbol="USDCAD", lot_size=1.0):
        """
        运行实时交易
...
def main():
    ...
    try:
        # 创建实时交易器实例
        trader = RealTimeTraderM15(model_path="usdcad_trained_model.pkl", magic_number=10032028)
        
        # 运行实时交易
        trader.run(symbol="USDCAD", lot_size=1.0)
